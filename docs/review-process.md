...
A substitute review is not claimed to be statistically independent in the same sense as a different reviewer. The process compensates by separating it from the frozen first pass, rebuilding the review surface, explicitly recording provenance, and requiring exact-head re-review after fixes.
